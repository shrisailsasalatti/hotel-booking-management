package com.virtusa.hotelreserve.bookingcontroller;
...
import com.virtusa.hotelreserve.bookingservice.BookingService;
...
public class BookingController 
{
	...
	public HttpStatus addBooking(@RequestBody Booking booking)
	{
		...
		boolean bookResult=bookingService.addBooking(booking);
	...
	public ResponseEntity<Booking> viewBookingDetailsById(@PathVariable("id") int id) 
	{
	...
	public ResponseEntity<Boolean> removeBookingById(@PathVariable("id") int id) 
	{
